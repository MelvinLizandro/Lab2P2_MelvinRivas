...
public class Lab2P2_MelvinRivas {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Usuario u1 = new Usuario("Melvin", "12341275", "alumno");
        Usuario u2 = new Usuario("Osmar", "123456789", "profesor");
        Usuario u3 = new Usuario("Tania", "987654321", "bibliotecaria");
        user.add(u1);
        user.add(u2);
        user.add(u3);
        ...
        while (retorno == 0) {
            ...
            System.out.print("Cual desea escoger: ");
            int numuser = input.nextInt();
            String tipouser = user.get(numuser).getTipouser();
            ...
            do {//inicio do while
                ...
                System.out.println("6. Regresar a los usuarios");
                ...
                switch (op) { //inicio switch
                    ...
                    case 2: {// agregar articulo 
                        ...
                        if (tipouser.contains("alumno")) {
                            System.out.println("");
                            System.out.println("---No tiene acceso suficiente para esta opcion--- ");
                        } else {
                            System.out.println("");
                    ...
                    case 3: {// case de remover 

                        if (tipouser.contains("alumno") || tipouser.contains("profesor")) {
                            System.out.println("");
                            System.out.println("---No tiene acceso suficiente para esta opcion--- ");
                        } else {
                            System.out.println("");
                    ...
                    case 4: {//case para modificar las cosas
                        if (tipouser.contains("alumno") || tipouser.contains("profesor")) {
                            System.out.println("");
                            System.out.println("---No tiene acceso suficiente para esta opcion--- ");
                        } else {
                ...
                System.out.println("");
            } while (op != 5 && op != 6); // fin del do while
